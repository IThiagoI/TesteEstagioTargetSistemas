...
public class Exercicio04 {
	 ...
	 * Resposta:
	 * 
	 * Os dois estarão na mesma distância, pois estão em sentidos opostos, 
	 * não importa quem é mais rápido ou não, porque na hora de um passar pelo outro, 
	 * ambos estarão na mesma distânica para chegar em Ribeirão Preto.
	 * 
	 *
	 * 
	 */
